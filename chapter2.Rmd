...
--- type:VideoExercise lang:r aspect_ratio:62.5 xp:50 skills:1 key:1112d937d2
...
Let's continue with the NBA research example. On your workspace is a simulated data set, called `NBA`, that closely resembles the data analyzed by Berger and Pope. The data frame `NBA` contains game outcomes for over 18,000 NBA games between 1994 and 2009.
...
In this exercise, you will compute the treatment effect of being behind at halftime on the final margin of victory. You will use regression methods as well as "nonparametric" methods to assess how robust the effect is.
