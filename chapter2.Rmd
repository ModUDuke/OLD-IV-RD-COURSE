...
A researcher is working on a question that could fit an IV analyis. They found an instrument and argued that it satisfies the 3 assumptions. They had good data (with only a small level of sampling error) and then used indirect inference to compute the causal effect of the treatment on outcomes. They found a positive causal effect on the outcome, and concluded that treatment is good. Is that a valid conclusion?
...
*** =sct
```{r}
msg1 = "It's not quite that clear. Try again"
msg2 = "If it's a convincing instrument and calculation, then it really might be valid. Try again"
