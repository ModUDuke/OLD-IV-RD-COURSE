...
# 1) Using a linear regression, compute the correlation between rain and opt-in status.
#---- Question 1-------------------------------------#
    Solution1<-lm( ~ ,data=CreditCo)
#----------------------------------------------------#

# 2) What is the p-value associated with the t-test on the coefficient of rain?
#---- Question 2-------------------------------------#
