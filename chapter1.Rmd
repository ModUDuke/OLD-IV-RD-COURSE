...
Suppose you are interested in the economic status of new college graduates, and have just gotten access to data on what kinds of places people move to after they graduate from college. In your first step of data analysis, you subset this geographic data to categorize locations as either urban or rural, giving you a binary treatment variable. What kind of variation does that variable have?
...
msg2 = "Correct! While there might be external reasons that affect people's choice of where to live, usually it's the case that people ultimately make the decision on where they want to live--unless they are in the military or in prison! So that choice is most likely related to some other unobserved variables in each individual's own mind (like if people who desire more money choose to live in urban areas), which produces endogenous variation."
