...
*** =sample_code
```{r}
# Run the McCrary test with the running variable in the NBA data
#---- Question 1-------------------------------------#
      Solution1 <- DCdensity(NBA$home.team.halftime.margin,0,plot=TRUE)
#----------------------------------------------------#
  
# Now issue the command again, but print the p-value output 
#---- Question 2-------------------------------------#
      Solution2<-print(DCdensity(NBA$home.team.halftime.margin,0,plot=TRUE))
#----------------------------------------------------#
