...
NBA$away.team.halftime.score  <- round(NBA$away.team.qual+rnorm(n, mean=47, sd=6), digits=0)
NBA$home.team.halftime.margin <- NBA$home.team.halftime.score - NBA$away.team.halftime.score
NBA$home.team.halftime.margin.cheat <- NBA$home.team.halftime.margin-1*(NBA$home.team.halftime.margin==0)
...
#---- Question 2-------------------------------------#
      Solution 2<- DCdensity(NBA$[running.var],[cutoff],plot=FALSE)
#----------------------------------------------------#
...
#---- Question 4-------------------------------------#
      Solution3 <- DCdensity(NBA$[new.running.var],[cutoff],plot=FALSE)
#----------------------------------------------------#
